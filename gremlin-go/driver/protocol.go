...
func newGremlinServerWSProtocol(handler *logHandler, url string, connSettings *connectionSettings, results *synchronizedMap,
	...
	gremlinProtocol := &gremlinServerWSProtocol{
		protocolBase: &protocolBase{transporter: nil},
